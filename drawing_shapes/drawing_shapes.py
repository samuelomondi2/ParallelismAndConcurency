...
def run_no_threads(tur, log, main_turtle, lock=None):
...
def run_with_threads(tur, log, main_turtle, lock):
    ...
    t2 = threading.Thread(target=draw_squares, args=(tur,lock))
...
def main():
    ...
    run_with_threads(turtle251, log, main_turtle, lock)
